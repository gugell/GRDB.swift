...
// MARK: - Infered Foreign Key

extension HasManyAssociationTests {
    // TODO: tests for left implicit row id, left compound primary key, and left unique key
    func testHasManyInferredForeignKey() throws {
...
// MARK: - Infered Left Primary Key

extension HasManyAssociationTests {
    // TODO: tests for left implicit row id, left compound primary key, and left unique key
    func testHasManyDefinitionFromSingleRightColumn() throws {
        struct Child : TableMapping, RowConvertible {
            static let databaseTableName = "children"
            let id: Int64
            let parentId: Int64
